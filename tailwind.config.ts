  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-safe': '0 0 20px hsl(var(--status-safe) / 0.3)',
        'glow-warning': '0 0 20px hsl(var(--status-warning) / 0.3)',
        'glow-critical': '0 0 25px hsl(var(--status-critical) / 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
